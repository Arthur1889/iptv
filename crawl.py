...
CCTV_DESC_MAP = {
    ...
    "CCTV12": "CCTV12 社会与法", "CCTV13": "CCTV13 新闻", "CCTV14": "CCTV14少儿", "CCTV15": "CCTV15 音乐",
...
def main():
    ...
    # 第六步：格式化生成标准的 M3U 文件 (tv.m3u)
    logging.info(f">>> [第六步] 正在注入输出 tv.m3u 文件...")
    with open(OUTPUT_M3U_PATH, "w", encoding="utf-8") as f:
        ...
        for res in final_output_list:
            ...
            # 严格按照标准的 M3U 扩展协议落地：左侧 tvg-id/tvg-name 保持匹配后的纯净标准名
